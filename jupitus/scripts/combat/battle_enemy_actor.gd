...
func _ready() -> void:
	...
	_target_area.input_pickable = target_selection_enabled
...
func set_intent(value: EnemyActionIntent) -> void:
	_intent = value
	_ensure_intent_label()
	_refresh_intent_label()


func set_debug_intent_visible(value: bool) -> void:
	_debug_intent_visible = value
	_refresh_intent_label()


func set_target_selection_enabled(value: bool) -> void:
...
func _ensure_intent_label() -> void:
	...
	_intent_label.position = Vector2(-90.0, -245.0)
	_intent_label.custom_minimum_size = Vector2(180.0, 28.0)
...
func _refresh_intent_label() -> void:
	...
	if _intent == null or not _debug_intent_visible:
...
func play_anticipation(
	...
	_feedback.play_anticipation(duration, reduced_motion)
