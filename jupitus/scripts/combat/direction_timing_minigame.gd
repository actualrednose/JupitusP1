...
func _rebuild_arrows() -> void:
	...
	for direction in _sequence:
		...
		outline.position = Vector2(44.0, 44.0)
		outline.rotation = (
		...
		arrow.position = Vector2(44.0, 44.0)
		arrow.rotation = (
			float(direction) * PI * 0.5
		)
...
func _resize_panel_for_sequence() -> void:
	...
	var panel_width := maxf(460.0, content_width)
...
func _make_arrow_polygon() -> PackedVector2Array:
...
func _submit_direction(
	...
	_set_arrow_result(_current_index, correct)
...
func _finish_attempt() -> void:
	...
	var timing_result := BattleAction.TimingResult.MISS
...
func _build_interface() -> void:
	...
	_panel.position = Vector2(-230.0, 90.0)
	_panel.custom_minimum_size = Vector2(
		460.0,
		220.0
	)
